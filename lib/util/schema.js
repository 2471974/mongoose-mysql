      ...
      switch (dataType) {
        ...
        case '[object Object]':
          if (typeof value.formatter !== 'undefined' && value.formatter instanceof _schema2.default.Formatter.Stringify) {
            ...
            value.type.forEach(function (element, index) {
              result.push.apply(result, _toConsumableArray(_this.insert(element, dataValue, _this.table(tableName, field), _this.index(autoIndex, field, index))));
            });
          }
          break;
        default:
